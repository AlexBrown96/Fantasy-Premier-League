            ...
            if file == "gw.csv":
                ...
                if sum(data[-5:]["minutes"])/len(data[-5:]) >= 0:
                    ...
                    if player_data.empty:
                        ...
                        points, value, pos = feature_prediction(team_code, player_id)
                ...
                # else:
                #     records.append([web_name, 0, value, pos, team_code, player_id])
                    #print("player: {} minutes too low: {}".format(web_name, sum(data[-5:]["minutes"])/len(data[-5:])))
