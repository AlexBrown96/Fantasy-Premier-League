...
def scrapeURL(url):
    ...
    features_wanted_player = {"player", "nationality", "position", "squad", "age", "games", "games_starts",
                              "games_subs", "minutes", "minutes_per_game", "goals_against", "goals_against_per90",
                              "shots_on_target_against", "save_perc", "wins", "draws", "losses", "clean_sheets",
                              "clean_sheets_perc"}
    ...
    features_wanted_squad = {"keepers_used", "games", "games_starts", "games_subs", "minutes", "minutes_per_game",
                             "goals_against", "goals_against_per90", "shots_on_target_against", "save_perc", "wins",
                             "draws", "losses", "clean_sheets", "clean_sheets_perc"}
...
scrapeURL("https://fbref.com/en/squads/5bfb9659/Leeds-United-Stats")
# scrapeURL("https://fbref.com/en/comps/10/Championship-Stats")